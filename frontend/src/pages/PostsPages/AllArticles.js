        ...
        return articles.slice(start, end).map((article, index) => (
            <div className={styles.articleItem} key={article.id}>
                ...
                <div className={styles.articleContent}>
                    ...
                    <a className={styles.readMore} onClick={() => handleArticleClick(article.id)}>Read more...</a>
                    ...
                    <div className={styles.articleDate}>{new Date(article.created_at).toLocaleDateString()}</div>
                </div>
            </div>
        ));
    };
