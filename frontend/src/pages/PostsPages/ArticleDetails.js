...
// Function to get CSRF token (needed for Django)
    ...
    if (!article) {
        return <div>Loading...</div>; // Display a loading message while the article is being fetched
    }
        ...
        <div className={styles.container}>
            ...
            <div className={`${styles.sidebar} ${styles.left}`}>
                ...
                <div className={styles['sidebar-featured']}>
                    <h3>Featured Photographer of the Month</h3>
                    {bestUser ? (
                        <>
                            <img src={getImageUrl(bestUser.profile_image)} alt={bestUser.username} className={styles["featured-img"]} />
                            <p>
                                <a href="#">Learn more about {bestUser.username}, our featured photographer this month!</a>
                            </p>
                        </>
                    ) : (
            ...
            {/* Bar1 between Left Sidebar and Middle */}
            ...
            {/* Bar2 between Middle and Right Sidebar */}
