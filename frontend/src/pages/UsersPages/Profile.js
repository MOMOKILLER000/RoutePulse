        ...
        <div className={styles.profile_mainContainer}>
          <div className={styles.profile_stanga}>
            <div className={styles.profile_poza}>
              ...
              <button
                className={styles.profileStangaButton}
                onClick={toggleNotif}
            ...
            <div className={styles.profile_socialMedia}>
              {[
                ...
                <div key={index} className={styles.profile_comun}>
                  {isEditing ? (
                    <div>
                      <FontAwesomeIcon icon={item.icon} className={styles.profile_icon} />
                      <input
                ...
                <ul className={styles.profile_ruta}>
                  {routes &&
                    routes.map((item, index) =>
                      item.route_type === 'Normal_Transport' ? (
                        <li className={styles.userRoutes} onClick={handleMyRoutes} key={index}>
                          {item.origin}
                        </li>
                      ) : (
                        <li className={styles.userRoutes} onClick={handleMyRoutes} key={index}>
