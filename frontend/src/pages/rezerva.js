            ...
            <div className={styles['map-container']}>
                ...
                <div className={styles['map']}>
                    <MapContainer center={mapCenter} zoom={13} style={{ height: '100%' }}>
                        ...
                        {nearestStop && (
                            <Marker position={[nearestStop.stop_lat, nearestStop.stop_lon]}>
                        ...
                        {allPolylinePositions.length > 0 && (
                            <Polyline positions={allPolylinePositions} color="blue" />
                        )}
                        {userLocation && <CenterMap location={[userLocation.lat, userLocation.lon]} />}
